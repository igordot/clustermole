...
The `gene` column is the gene symbol (human or mouse), the `gene_original` column is the gene symbol from the source database, and the `celltype_full` column contains the full cell type string, including the species and the original database.

Many tools that work with gene sets require input as a list.
