...
```{r find-markers-b, message=FALSE}
...
```{r find-markers-acar, message=FALSE}
...
```{r find-markers-o, message=FALSE}
...
The top results are noisier than for B-cells, but the appropriate populations are listed.
